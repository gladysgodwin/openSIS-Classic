...
Sub SendUploadResults( errorNumber, fileUrl, fileName, customMsg )
	...
	Response.Write "(function(){var d=document.domain;while (true){try{var A=window.parent.document.domain;break;}catch(e) {};d=d.replace(/.*?(?:\.|$)/,'');if (d.length==0) break;try{document.domain= _d;}catch (e){break;}}})();"
